...
DEFAULT_FONT_NAME = "monaco.ttf"
DEFAULT_SYSFONT_NAME = None
FONT_NAME_TEMPLATE = "data/fonts/%s"
DEFAULT_COLOR = "white"
...
# Options objects encapsulate the keyword arguments to functions that take a lot of optional keyword arguments.
